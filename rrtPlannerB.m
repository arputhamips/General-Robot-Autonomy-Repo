function [dataStore] = rrtPlannerB(Robot, maxTime)
% rrtPlanner
% 
...
% Load the map
load('labBoxMap_wall_purple_with_goals_2025.mat'); % assumes "map" variable is loaded
...
% Start control loop
tic;
while gotopt <= size(waypoints, 1) && toc < maxTime
    [~, dataStore] = readStoreSensorData(Robot, 0, dataStore);
