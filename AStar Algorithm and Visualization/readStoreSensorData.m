...
try 
    ...
    %store deadReck data by calling integrateOdom
%     try
%         final_pose = integrateOdom([px; py;pt],deltaD,deltaA);
%         dataStore.deadReck = [dataStore.deadReck ; ...
%                                toc final_pose(1) final_pose(2) final_pose(3)];
%     catch
%         disp('Error retrieving or saving beadReck (integrateOdom) data.');
%     end
